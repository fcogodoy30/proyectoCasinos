...
ALLOWED_HOSTS = ['www.buenamezcla.com', '193.203.167.65']
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': 'GaUWf/Y7',
        'HOST': 'srv1435.hstgr.io',  # O la direcciÃ³n IP de tu servidor MySQL
...
LOGIN_REDIRECT_URL = 'principal'  # Esto redirigirÃ¡ al usuario a la vista 'principal' despuÃ©s de iniciar sesiÃ³n
LOGIN_URL = '/'  # Esta es la URL a la que se redirigirÃ¡ si un usuario no autenticado intenta acceder a una vista protegida
